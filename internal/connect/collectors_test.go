...
func TestFetchSystemInformation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			collectorOpts := collectors.NewCollectorOptions(map[string]collectorsconfig.CollectorConfig{})
			...
			result, err := FetchSystemInformation(tt.arch, collectorOpts)
...
func TestFetchSystemInformationCollectorConfig(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			config: map[string]collectorsconfig.CollectorConfig{"cpu": {State: collectors.StateDisabled}},
			checkFields: map[string]bool{
				"cpus": true,
			},
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			collectorOpts := collectors.NewCollectorOptions(tt.config)

			result, err := FetchSystemInformation(collectors.ARCHITECTURE_X86_64, collectorOpts)
			assert.Nil(err)
...
func TestFetchSystemProfiles(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := FetchSystemProfiles(tt.arch, tt.updateCache, collectorOpts)
...
func TestFetchSystemProfilesCollectorConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := FetchSystemProfiles(collectors.ARCHITECTURE_X86_64, false, collectorOpts)
			assert.Nil(err)
